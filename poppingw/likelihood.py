...
class BNSPopulation(Likelihood):
    PARAMETER_NAMES = ['N_total', 'n', 'a', 'b']

    def __init__(self, log_dL_array: np.ndarray, pdL_value: np.ndarray, selection: BNSSelection, z_prior: RedshiftPrior, cosmo: Cosmology = planck, z_range: tuple = (0.001, 6)):
